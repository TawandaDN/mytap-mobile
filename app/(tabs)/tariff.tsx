    ...
    <ScreenContainer>
        ...
        <GlassCard bubbleColor="rgba(46,204,113,0.15)" style={styles.ringCard}>
          <View style={styles.ringWrap}>
            <ProgressRing
              ...
              gradient={[ringColor, t.usedPct < 60 ? '#2ECC71' : '#F5A623', '#E74C3C']}
            >
      ...
      <StaggeredItem index={2}>
        <GlassCard bubble={false}>
          ...
          <View style={styles.planFooter}>
            ...
            <Pressable style={styles.manageBtn} onPress={() => { setBundleModal(true); haptics.medium(); }}>
      ...
      <SlideUpModal visible={bundleModal} onClose={() => setBundleModal(false)}>
        ...
        {[1, 2, 5, 10].map((gb) => (
          <Pressable
            key={gb}
            style={[styles.bundleOption, { borderColor: theme.border }]}
            onPress={() => {
              haptics.selection();
              addBundle(gb);
            }}
