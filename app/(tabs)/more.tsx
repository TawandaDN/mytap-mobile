  ...
  const sections = [
    {
      title: 'Money',
      items: [
        { icon: 'sparkles', label: 'Insights', color: '#8A4A9A', onPress: () => go('/insights') },
    ...
    <ScreenContainer>
        ...
        <PressableScale onPress={() => go('/assistant')}>
          <GlassCard bubbleColor="rgba(52,152,219,0.15)">
            <View style={styles.shortcutRow}>
              <View style={[styles.shortcutIcon, { backgroundColor: '#3498DB' }]}>
      ...
      <StaggeredItem index={3}>
        <GlassCard bubbleColor="rgba(46,204,113,0.15)">
          <View style={styles.shortcutRow}>
            <View style={[styles.shortcutIcon, { backgroundColor: '#2ECC71' }]}>
            ...
            <View style={styles.shortcutInfo}>
              ...
              <Text style={[styles.shortcutSub, { color: theme.textMuted }]}>
                {state.biometricEnabled ? 'Face ID / fingerprint enabled' : 'Lock the app with Face ID'}
              </Text>
            </View>
            <Switch
