...
/**
 * NFC Stickers — real sticker information (serial, taps, last used), a working
 * freeze/activate toggle, and design customization applied to the sticker.
 * Cards sit flat with a restrained 2px lift (300ms ease-out) — no tilt/spin.
 */
  ...
  return (
    <ScreenContainer>
          ...
          <View style={styles.stickerCard}>
            ...
            >
              ...
              <PressableScale
                style={[
                  styles.toggleBtn,
                  { backgroundColor: s.status === 'active' ? '#D92D20' : theme.primary },
                ]}
      ...
      <StaggeredItem index={state.stickers.length + 1}>
        ...
        <GlassCard bubbleColor="rgba(109,90,230,0.14)">
          <View style={styles.designRow}>
            ...
            <PressableScale
              style={[styles.designBtn, { backgroundColor: theme.primary }]}
        ...
        <GlassCard solid bubble={false}>
          {[
            ...
            <View key={i} style={[styles.activityRow, i > 0 && styles.activityDivider]}>
              <View style={[styles.activityIcon, { backgroundColor: theme.primary + '14' }]}>
              ...
              <Text style={[styles.activityAmount, { color: theme.danger }]}>{a.amount}</Text>
            </View>
          ))}
        </GlassCard>
      </StaggeredItem>
      ...
      <SlideUpModal visible={designModal} onClose={() => setDesignModal(false)}>
        ...
        <View style={styles.designGrid}>
          {STICKER_DESIGNS.map((d) => (
            <PressableScale
              key={d.id}
              style={[styles.designCard, { borderColor: appliedDesign === d.id ? theme.primary : theme.hairline }]}
