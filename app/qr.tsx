...
export default function QrScreen() {
  ...
  const pay = () => {
    ...
    haptics.processing();
    setTimeout(() => {
      dispatch({ type: 'PAY', cardId: 'wallet', amount: amt, merchant: 'QR Merchant', category: 'QR Payment', icon: '📱', color: '#6B3A8A', method: 'MyTap Wallet' });
      const r = {
        id: `r-${Date.now()}`,
    ...
    <ScreenContainer>
      ...
      <StaggeredItem index={2}>
        <GlassCard bubble={false}>
          ...
          <Button title="Pay with QR" onPress={pay} style={styles.payBtn} />
        </GlassCard>
      </StaggeredItem>
